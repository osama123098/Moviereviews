...
SECRET_KEY = 'django-insecure-k2*r2#&b(!1n2@0+lx3sh0*8uqfhy@$p6vl^d^0)--%ioe7xfn'
...
# adding root of live media files
MEDIA_ROOT = os.path.join(BASE_DIR,'media')
MEDIA_URL = '/media/'

# adding path of static 
STATICFILES_DIRS = [
BASE_DIR / 'moviereviews/static/',
]

"""This redirects a user (who is not logged in) to the
 login page when they attempt to access an 
 authoried page"""
